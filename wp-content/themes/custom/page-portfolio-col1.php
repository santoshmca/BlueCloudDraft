			...
			<div class="<?php if($terms) : foreach ($terms as $term) { echo 'term-'.$term->slug.' '; } endif; ?>portfolio-item-one sixteen columns">
				...
				<?php if ( has_post_thumbnail()) { ?> 
					...
					<div class="portfolio-picwrap">
						<?php echo $link; ?><span class="portfolio-pic"><?php the_post_thumbnail('eight-columns-thin'); ?><div class="portfolio-overlay"><?php echo $lightboxtype; ?></div></span></a>
					</div>
					<div class="portfolio-desc">
				  		...
				  		<?php the_excerpt(); ?>
				  		<a href="<?php the_permalink() ?>" class="button"><?php _e('View Details', 'minti'); ?></a>
